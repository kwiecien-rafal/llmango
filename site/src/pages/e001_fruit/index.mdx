...
title: "001: fruit - does an LLM have language-based preferences?"
description: "Can an LLM's response meaningfully change when you prompt it in a different language, or when you present information to the model in a different manner? Analysing 34 000 LLM responses across English, Polish and Japanese."
type: "article"
